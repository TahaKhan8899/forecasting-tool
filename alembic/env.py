...
# Import the Base and settings for environment variable access
...
def do_run_migrations(connection):
    """Run migrations in 'online' mode with a pre-established connection."""
    context.configure(
...
def run_migrations_online() -> None:
    ...
    """
    # Run the async migrations function in the asyncio event loop
